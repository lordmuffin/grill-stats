...
def login_and_simulate() -> None:
    ...
    if "Login" not in login_response.text:
        ...
        # Start a simulation
        simulation_data = {"device_id": "mock_device_001", "profile": "grilling"}

        simulation_response = session.post("http://localhost:5000/api/sessions/simulate", json=simulation_data)
