"""
Unit tests for authentication with isolated database operations.

This module uses mocked models to avoid circular dependencies.
"""
...
from auth.utils import check_password, create_test_user, generate_password_hash
...
class IsolatedAuthTestCase(TestCase):
    """Test case for authentication functionality with isolated database operations"""
    ...
    def create_app(self):
        ...
        # Initialize Mock User model to avoid circular dependencies
        self.user_manager = MockUser(self.db)
