...
from rfx_gateway_client import RFXGatewayClient, GatewaySetupStatus, GatewaySetupStep, WiFiNetwork
...
class TestRFXGatewayAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.temp_token_file.write(json.dumps({
    ...
    def test_configure_wifi(self):
        ...
        # Make request
        response = self.client.post('/api/gateways/001122334455/wifi/configure', json={
            'ssid': 'Home WiFi',
