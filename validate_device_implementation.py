...
def check_api_endpoints():
    ...
    try:
        ...
        endpoints = [
            ...
            ('@device_api.route(\'/<device_id>\', methods=[\'DELETE\'])', 'Device removal endpoint'),
            ('@device_api.route(\'\', methods=[\'GET\'])', 'Device listing endpoint'),
            ('@device_api.route(\'/<device_id>\', methods=[\'GET\'])', 'Device details endpoint'),
            ('@device_api.route(\'/<device_id>/nickname\'', 'Device nickname update endpoint'),
...
def check_security_features():
    ...
    try:
        ...
        security_features = [
            ...
            ('device_manager.get_user_device(current_user.id', 'User ownership verification'),
