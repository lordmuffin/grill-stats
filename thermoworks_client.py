...
class ThermoWorksClient:
    def __init__(self, api_key: str, base_url: str = "https://api.thermoworks.com", mock_mode: bool = None):
    ...
    def get_historical_data(self, device_id: str, start_time: str, end_time: str, probe_id: Optional[str] = None) -> List[Dict]:
        if self.mock_mode and self.mock_service:
            from datetime import datetime
            try:
