        ...
        if state:
            try:
                ...
                if os.path.exists(verifier_path):
                    ...
                    if (verifier_data.get("state") != state or 
                            time.time() - verifier_data.get("created_at", 0) > 600):
    ...
    def refresh_token(self) -> AuthToken:
        ...
        try:
            ...
            if hasattr(e, "response") and e.response is not None:
                ...
                if status_code in (400, 401) and error_data.get("error") in ("invalid_grant", "invalid_token"):
                    self.token = None
                ...
                if attempt < retry_count - 1:
                    ...
                    if hasattr(e, "response") and e.response is not None:
                        ...
                        try:
                            ...
                            error_data = {"error": "Unknown error", "details": e.response.text}
