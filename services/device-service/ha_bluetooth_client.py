...
class HomeAssistantBluetoothClient:
    ...
    def discover_devices(self, scan_duration: int = 10) -> List[BluetoothDevice]:
        ...
        try:
            ...
            self.client.post('/api/services/bluetooth/start_discovery', {
    ...
    def connect_device(self, device_id: str) -> bool:
        ...
        try:
            ...
            response = self.client.post(f'/api/bluetooth/connect', {
                'device_id': device_id
            })
    ...
    def disconnect_device(self, device_id: str) -> bool:
        ...
        try:
            response = self.client.post(f'/api/bluetooth/disconnect', {
                'device_id': device_id
            })
    ...
    def send_data(self, device_id: str, data: bytes) -> bool:
        ...
        try:
            response = self.client.post(f'/api/bluetooth/write', {
                'device_id': device_id,
                'data': data.hex()
            })
    ...
    def receive_data(self, device_id: str, timeout: int = 5) -> Optional[bytes]:
        ...
        try:
            response = self.client.get(f'/api/bluetooth/read', {
                'device_id': device_id,
                'timeout': timeout
            })
