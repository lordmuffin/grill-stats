    ...
    def register_gateway(self, gateway_data: Dict) -> Dict:
        ...
        try:
            ...
            with conn.cursor() as cur:
                ...
                cur.execute("SELECT id FROM gateway_status WHERE gateway_id = %s", (gateway_data["gateway_id"],))
                exists = cur.fetchone()
            ...
            logger.error("Failed to register gateway", gateway_id=gateway_data.get("gateway_id"), error=str(e))
            raise
    ...
    def update_gateway_status(self, gateway_id: str, status_data: Dict) -> Dict:
        ...
        try:
            ...
            with conn.cursor() as cur:
                ...
                for field in [
                    "online", "wifi_connected", "wifi_ssid", "wifi_signal_strength",
                    "cloud_linked", "last_seen", "status", "firmware_version"
                ]:
                ...
                if "metadata" in status_data:
                    if status_exists:
                        ...
                        cur.execute("SELECT metadata FROM gateway_status WHERE gateway_id = %s", (gateway_id,))
                        result = cur.fetchone()
