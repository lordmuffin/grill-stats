...
# Override the database URL from environment variables if provided
...
def run_migrations_online():
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            # Use compare_type=True to detect column type changes
            compare_type=True,
            # Use compare_server_default=True to detect default value changes
