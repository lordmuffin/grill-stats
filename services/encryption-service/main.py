...
def encrypt_credentials():
    ...
    try:
        ...
        encrypted_credential = encryption_service.encrypt_credentials(
            email=data["email"], password=data["password"], user_id=data["user_id"]
        )
        ...
        return (
            jsonify({"error": "Failed to encrypt credentials", "details": str(e)}),
            500,
        )
...
def decrypt_credentials():
    ...
    try:
        ...
        plain_credential = encryption_service.decrypt_credentials(
            encrypted_credential=encrypted_credential, user_id=data["user_id"]
        )
        ...
        return (
            jsonify({"error": "Failed to decrypt credentials", "details": str(e)}),
            500,
        )
...
def rotate_key():
    ...
    try:
        ...
        return jsonify({"error": "Failed to rotate key", "details": str(e)}), 500
...
def get_key_info():
    ...
    try:
        ...
        return jsonify({"error": "Failed to get key info", "details": str(e)}), 500
...
def check_rate_limit(user_id):
    ...
    try:
        ...
        return jsonify({"error": "Failed to check rate limit", "details": str(e)}), 500
