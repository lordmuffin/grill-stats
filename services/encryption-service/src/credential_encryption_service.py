...
from audit_logger import get_audit_logger, log_credential_encrypt, log_credential_decrypt, log_authentication, log_rate_limit_exceeded, log_security_violation, log_key_rotation, log_service_start, log_error
...
class CredentialEncryptionService:
    ...
    def decrypt_credentials(self, encrypted_credential: EncryptedCredential, user_id: str) -> PlainCredential:
        ...
        try:
            ...
            if not encrypted_credential or not encrypted_credential.encrypted_email or not encrypted_credential.encrypted_password:
                log_security_violation(user_id, "invalid_encrypted_data", 
                                     details={"has_email": bool(encrypted_credential and encrypted_credential.encrypted_email),
