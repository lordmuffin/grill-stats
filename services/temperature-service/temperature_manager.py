...
class TemperatureManager:
    def __init__(self, influxdb_host: str, influxdb_port: int, influxdb_database: str, 
                 influxdb_username: str = None, influxdb_password: str = None):
        ...
        try:
            ...
            for policy in retention_policies:
                try:
                    ...
                    logger.info("Created retention policy", name=policy['name'], duration=policy['duration'])
                except Exception as e:
                    # Policy might already exist
                    logger.debug("Retention policy creation skipped", name=policy['name'], error=str(e))
    ...
    def store_temperature_reading(self, reading_data: Dict) -> bool:
        ...
        try:
            ...
            if success:
                ...
                logger.warning("Failed to store temperature reading", device_id=reading_data['device_id'])
            
            return success
            
        except Exception as e:
            logger.error("Error storing temperature reading", 
    ...
    def get_temperature_history(self, device_id: str, probe_id: Optional[str] = None,
        ...
        try:
            ...
            logger.debug("Temperature history retrieved", 
                        device_id=device_id, 
            ...
            logger.error("Error retrieving temperature history", 
                        device_id=device_id, 
                        error=str(e))
            return []
    
    def get_temperature_statistics(self, device_id: str, probe_id: Optional[str] = None,
                                 start_time: Optional[datetime] = None,
        ...
        try:
            ...
            logger.error("Error retrieving temperature statistics", 
                        device_id=device_id, 
                        error=str(e))
            return {}
    
    def get_temperature_alerts(self, device_id: str, probe_id: Optional[str] = None,
                             start_time: Optional[datetime] = None,
                             end_time: Optional[datetime] = None,
                             threshold_high: float = 250.0,
                             threshold_low: float = 32.0) -> List[Dict]:
        ...
        try:
            ...
            logger.debug("Temperature alerts retrieved", 
                        device_id=device_id, 
                        count=len(alerts))
            ...
            logger.error("Error retrieving temperature alerts", 
                        device_id=device_id, 
                        error=str(e))
            return []