...
class ThermoWorksClient:
    ...
    def get_temperature_data(self, device_id: str, probe_id: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            logger.info(
                "Temperature data retrieved from ThermoWorks",
                device_id=device_id,
            ...
            logger.error(
                "Failed to get temperature data from ThermoWorks",
                device_id=device_id,
                error=str(e),
            )
            return {}
    ...
    def get_multiple_temperature_readings(self, device_ids: List[str]) -> List[Dict]:
        ...
        try:
            ...
            logger.info(
                "Batch temperature data retrieved from ThermoWorks",
            ...
            logger.error(
                "Failed to get batch temperature data from ThermoWorks",
                device_ids=device_ids,
                error=str(e),
            )
            return []

    def get_historical_temperature_data(
        self,
        device_id: str,
        start_time: str,
        end_time: str,
        ...
        try:
            ...
            logger.info(
                "Historical temperature data retrieved from ThermoWorks",
                device_id=device_id,
            ...
            logger.error(
                "Failed to get historical temperature data from ThermoWorks",
                device_id=device_id,
                error=str(e),
            )
            return []
    ...
    def get_device_probes(self, device_id: str) -> List[Dict]:
        ...
        try:
            ...
            logger.info(
                "Device probes retrieved from ThermoWorks",
                device_id=device_id,
            ...
            logger.error(
                "Failed to get device probes from ThermoWorks",
                device_id=device_id,
                error=str(e),
            )
            return []
