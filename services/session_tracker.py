...
class SessionTracker:
    ...
    def process_temperature_reading(self, device_id: str, temperature: float, timestamp: datetime = None, user_id: int = None):
        """
            ...
            for session in active_sessions:
                ...
                if device_id in device_list:
                    ...
                    if duration >= self.MIN_SESSION_DURATION:
                        ...
                        logger.info(f"Session ended for device {device_id}, session_id: {session.id}, duration: {duration} minutes")
    ...
    def get_session_status(self, device_id: str) -> Dict:
        ...
        return {
            ...
            'buffer_status': {
                ...
                'latest_temp': self.device_temp_buffers[device_id][-1]['temperature'] if self.device_temp_buffers[device_id] else None,
                'latest_time': self.device_temp_buffers[device_id][-1]['timestamp'].isoformat() if self.device_temp_buffers[device_id] else None
            }
        }
