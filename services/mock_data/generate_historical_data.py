...
def generate_ambient_curve(device_id: str, probe_id: str, start_time: datetime, target_temp: float = 225.0) -> List[Dict[str, Any]]:
...
if __name__ == '__main__':
    ...
    print(f"Time range: {historical_data['metadata']['time_range']['start']} to {historical_data['metadata']['time_range']['end']}")
