...
class MockDataService:
    ...
    def _load_device_data(self) -> None:
        ...
        try:
            ...
            logger.debug("Loaded device data for %d devices", len(self._device_data.get('devices', [])))
    ...
    def get_historical_data(self, device_id: str, probe_id: str, 
    ...
    def _generate_synthetic_historical_data(self, device_id: str, probe_id: str, 
