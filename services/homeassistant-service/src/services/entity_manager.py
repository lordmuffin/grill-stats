...
from ..models.entity_models import (
    EntityRegistry, EntityState, TemperatureSensor, DeviceEntity,
    EntityType, DeviceClass
)
...
class EntityManager:
    ...
    def get_entities_by_device(self, device_id: str) -> List[EntityState]:
        return [
            entity for entity in self.registry.entities.values()
            if entity.attributes.get("device_id") == device_id
        ]
