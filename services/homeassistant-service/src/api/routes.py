...
from ..models.entity_models import DeviceEntity, TemperatureSensor
from ..models.ha_models import HAConfig, HAEvent, HAServiceCall
    ...
    def setup_routes(self, app: Flask):
        ...
        def register_device():
            try:
                ...
                discovery_success = await self.discovery_service.register_device_discovery(data["device_id"], data)
                ...
                return (
                    jsonify(
                        {"status": "success", "message": "Device registered successfully", "device_id": data["device_id"]}
                    ),
                    200,
                )
        ...
        def sync_device_state(device_id: str):
            try:
                ...
                return (
                    jsonify({"status": "success", "message": "Device state synced successfully", "device_id": device_id}),
                    200,
                )
        ...
        def get_entities():
            try:
                ...
                return jsonify({"entities": entities_data, "count": len(entities_data)}), 200
        ...
        def create_automation():
            try:
                ...
                return (
                    jsonify(
                        {"status": "success", "automation_id": automation_id, "message": "Automation created successfully"}
                    ),
                    200,
                )
        ...
        def list_automations():
            try:
                ...
                return jsonify({"automations": automations_data, "count": len(automations_data)}), 200
                    ...
                    jsonify(
                        {
                            ...
                            "home_assistant_connection": {
                                ...
                                "last_successful_connection": (
                                    ha_health.last_successful_connection.isoformat()
                                    if ha_health.last_successful_connection
                                    else None
                                ),
