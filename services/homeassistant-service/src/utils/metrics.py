...
class MetricsCollector:
    ...
    def record_connection_failure(self):
        try:
            ...
            self.error_history.append({"type": "connection_failure", "timestamp": datetime.utcnow().isoformat()})
        ...
        try:
            ...
            if success:
                ...
                self.error_history.append(
                    {"type": "api_failure", "endpoint": endpoint, "timestamp": datetime.utcnow().isoformat()}
                )
    ...
    def record_service_call(self, service: str, success: bool):
        try:
            ...
            if success:
                ...
                self.error_history.append(
                    {"type": "service_failure", "service": service, "timestamp": datetime.utcnow().isoformat()}
                )
    ...
    def record_event_sent(self, event_type: str, success: bool):
        try:
            ...
            if success:
                ...
                self.error_history.append(
                    {"type": "event_failure", "event_type": event_type, "timestamp": datetime.utcnow().isoformat()}
                )
        ...
        try:
            if self.connection_metrics.total_attempts > 0:
                self.connection_metrics.uptime_percentage = (
                    self.connection_metrics.successful_connections / self.connection_metrics.total_attempts * 100
                )
        except Exception as e:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        try:
            ...
            total_requests = (
                self.api_metrics.total_calls + self.service_metrics.total_calls + self.event_metrics.total_events_sent
            )
            ...
            return {
                ...
                "connection": {
                    ...
                    "success_rate": (
                        self.connection_metrics.successful_connections / max(self.connection_metrics.total_attempts, 1) * 100
                    ),
                ...
                "api": {
                    ...
                    "success_rate": (self.api_metrics.successful_calls / max(self.api_metrics.total_calls, 1) * 100),
                ...
                "services": {
                    ...
                    "success_rate": (self.service_metrics.successful_calls / max(self.service_metrics.total_calls, 1) * 100),
                ...
                "events": {
                    ...
                    "success_rate": (
                        self.event_metrics.successful_events / max(self.event_metrics.total_events_sent, 1) * 100
                    ),
