...
from src.models.entity_models import DeviceEntity, TemperatureSensor
...
class TestHomeAssistantIntegration:
    ...
    def ha_config(self):
        return HAConfig(
            base_url="http://test-homeassistant:8123", access_token="test-token", verify_ssl=False, entity_prefix="test_grill"
        )
    ...
    async def test_device_state_synchronization(self, state_sync):
        ...
        device_id = "test_device_001"
        state_data = {"battery_level": 80, "signal_strength": -50, "is_connected": True}
    ...
    def test_device_offline_automation(self, automation_helper):
        ...
        automation_id = automation_helper.create_device_offline_automation(
            device_id="test_device_001", alert_name="Device Offline Alert", offline_duration="00:05:00"
        )
    ...
    def test_battery_low_automation(self, automation_helper):
        ...
        automation_id = automation_helper.create_battery_low_automation(
            device_id="test_device_001", battery_threshold=20, alert_name="Low Battery Alert"
        )
    ...
    def test_automation_management(self, automation_helper):
        ...
        automation_id = automation_helper.create_temperature_alert_automation(
            device_id="test_device_001", probe_id="1", alert_name="Test Alert", temperature_threshold=200.0
        )
    ...
    def test_automation_stats(self, automation_helper):
        ...
        automation_helper.create_device_offline_automation(device_id="test_device_001", alert_name="Offline Alert")
    ...
    async def test_complete_integration_workflow(
        self, mock_ha_client, entity_manager, state_sync, discovery_service, automation_helper, sample_temperature_data
    ):
        """Test complete integration workflow"""
        # 1. Register device
        device_entity = DeviceEntity(
            device_id=sample_temperature_data.device_id, name="Test Grill Device", manufacturer="ThermoWorks"
        )
        ...
        offline_alert_id = automation_helper.create_device_offline_automation(device_id=sample_temperature_data.device_id)
        ...
        success = await discovery_service.register_device_discovery(sample_temperature_data.device_id, device_info)
        assert success == True
