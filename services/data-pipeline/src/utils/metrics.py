...
class MetricsCollector:
    ...
    def record_temperature_reading(self, device_id: str, temperature: float, 
                                  device_name: str = "", location: str = "", 
    ...
    def record_homeassistant_update(self, entity_type: str, status: str, duration: float = None):
        ...
        self.homeassistant_updates.labels(
    ...
    def get_performance_history(self, component: str, metric_name: str, 
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'performance_components': list(set(
