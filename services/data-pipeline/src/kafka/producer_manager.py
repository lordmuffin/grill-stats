...
class ProducerManager:
    ...
    async def _send_message_sync(self, topic: str, key: Optional[str], value: str, headers: Optional[Dict[str, str]]):
    ...
    async def send_event(self, topic: str, event: BaseEvent, key: Optional[str] = None, headers: Optional[Dict[str, str]] = None):
        ...
        try:
            ...
            logger.error("Failed to queue event", topic=topic, event_id=getattr(event, 'event_id', 'unknown'), error=str(e))
            raise
    
    async def send_raw_message(self, topic: str, value: Union[str, Dict[str, Any]], key: Optional[str] = None, headers: Optional[Dict[str, str]] = None):
    ...
    async def send_batch(self, topic: str, events: List[BaseEvent], key_field: Optional[str] = None, headers: Optional[Dict[str, str]] = None):
        ...
        try:
            ...
            logger.error("Failed to queue batch events", topic=topic, count=len(events), error=str(e))
            raise
