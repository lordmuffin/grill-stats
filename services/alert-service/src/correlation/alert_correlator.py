...
from ..models.alert_models import Alert, AlertCorrelation, AlertStatus, AlertSeverity
...
class AlertCorrelator:
    ...
    async def _apply_ml_filtering(
        ...
        if (datetime.utcnow() - self.last_model_update).total_seconds() > \
           self.config['ml_model_update_interval']:
    ...
    async def get_correlation_statistics(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            'accuracy_rate': 1 - (self.correlation_metrics['false_positives'] / 
